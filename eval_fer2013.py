...
def parse_args():
    parser = argparse.ArgumentParser(description='Evaluate GReFEL on FER2013 test set')
    ...
    parser.add_argument('--output_dir', type=str, default='eval_results_fer2013', help='Directory to save evaluation results')
