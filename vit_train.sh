...
export LEARNING_RATE="0.00025"         # Lower learning rate for better stability
export NUM_EPOCHS="300"                # Longer training with cyclic learning rate
...
export WARMUP_EPOCHS="10"             # Extended warmup for stability
...
export SWA_START_EPOCH="40"           # Start SWA early to capture more models
export SWA_FREQ="2"                   # More frequent averaging
export FAST_SWA_FINALIZE="1"          # Set to 1 for faster SWA finalization (less accurate but much quicker)

# Knowledge Distillation settings
export SELF_DISTILLATION_ENABLED="1"
export SELF_DISTILLATION_START="30"   # Start self-distillation earlier
export SELF_DISTILLATION_TEMP="5.0"   # Higher temperature for smoother probabilities
export SELF_DISTILLATION_ALPHA="0.7"  # Stronger distillation weight

#==============================================================================
# CLASS BALANCING AND LOSS FUNCTION
#==============================================================================
# Focus more on difficult classes
export USE_FOCAL_LOSS="1"
export FOCAL_GAMMA="2.5"              # Higher gamma to focus more on hard examples
export LABEL_SMOOTHING="0.25"         # Increased label smoothing
export KL_WEIGHT="0.3"                # Increased KL weight

# Enable class balancing
export BALANCE_DATASET="1"
export TARGET_SAMPLES_PER_CLASS="5000" # Target for oversampling

#==============================================================================
# REGULARIZATION
#==============================================================================
export WEIGHT_DECAY="0.001"           # Increased weight decay
export HEAD_DROPOUT="0.6"             # Higher dropout for classification head
export FEATURE_DROPOUT="0.4"          # Higher feature dropout
export GRAD_CLIP_VALUE="0.5"          # Explicit gradient clipping

#==============================================================================
# DATA AUGMENTATION
#==============================================================================
export MIXUP_PROB="0.7"               # Aggressive augmentation to combat overfitting
export CUTMIX_PROB="0.6"              # High CutMix probability
export MIXUP_ALPHA="1.2"              # Strong mixup interpolation
export CUTMIX_ALPHA="1.4"             # Strong cutmix effect

# Enable progressive augmentation
export PROGRESSIVE_AUGMENTATION="1"
export PHASE_1_EPOCHS="15"
export PHASE_2_EPOCHS="40"
export PHASE_3_EPOCHS="70"
export PHASE_4_EPOCHS="150"

#==============================================================================
# EARLY STOPPING
#==============================================================================
export EARLY_STOPPING_PATIENCE="50"   # Increased patience for cyclic learning rates
